...
public class DayHeaderView: UIView {
  ...
  override public func layoutSubviews() {
    ...
    swipeLabelView.anchorAndFillEdge(.top, xPad: 0, yPad: 10, otherSize: daySymbolsViewHeight)
    daySymbolsView.anchorAndFillEdge(.top, xPad: 0, yPad: 40, otherSize: daySymbolsViewHeight)
